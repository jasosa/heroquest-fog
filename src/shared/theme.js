// ─── HeroQuest theme — mix: dark leather sidebar + warm parchment board ────────

// Fonts (loaded via index.html Google Fonts)
export const FONT_TITLE    = "'Cinzel Decorative', 'Palatino Linotype', serif"; // app/screen titles
export const FONT_HEADING  = "'Cinzel', 'Palatino Linotype', serif";            // section headings, buttons
export const FONT_BODY     = "'IM Fell English', 'Palatino Linotype', serif";   // body text, descriptions
